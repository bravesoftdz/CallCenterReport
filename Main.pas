...
type
  TForm1 = class(TForm)
    ...
    StatusBar10: TStatusBar;
    StatusBar11: TStatusBar;
    StatusBar12: TStatusBar;
    ...
    procedure OKRightDlgFind(Sender: TObject; Siga:Boolean=True);
...
begin
  ...
  Gauge1.Progress := 0;
  StatusBar1.Panels[1].Text:='Correcto     ';
...
procedure TForm1.OKRightDlgFind(Sender: TObject; Siga:Boolean=True);
var
  i, j, h :Integer;
  pagina1: Twincontrol;
  //Siga :Boolean;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  SetFocus;
                  //Refresh;
                  //Selection:=TGridRect(Rect(j,i,j+20,i+5));
                  //Selection.TopLeft := j;
                  //Selection.BottomRight:=i;
...
begin
    ...
    Try
      ...
      RestRequest2.Params.ParameterByName('valor').Value := 'select * from qagent';
      campo:=2;
      compo:='CheckListBox2';
  ...
  //OKRightDlg.Options := [frDown, frHideWholeWord, frHideUpDown];
...
begin
  ...
  StatusBar2.Panels[0].Text := StringGrid1.Hint;
...
begin
  ...
  do begin
    ...
    then begin
      ...
      //if C<=1 then
        SortStringGrid(TStringGrid(Sender),C, StrGrid[TStringGrid(Sender).Name][C].Val); //gdInteger)
      //else
...
begin
  ...
  label14.Caption:=IntToStr(DaysBetween(DateTimePicker1.Date, DateTimePicker2.Date))+ ' Días';
  with datamodule2 do
  begin
...
begin
  ...
  label33.Caption:=IntToStr(DaysBetween(DateTimePicker1.Date, DateTimePicker2.Date))+ ' Días';
...
begin
  ...
  label50.Caption:=IntToStr(DaysBetween(DateTimePicker1.Date, DateTimePicker2.Date))+ ' Días';
